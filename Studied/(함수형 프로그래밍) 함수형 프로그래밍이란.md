...
- **객체지향은 서로 관심있는 것들끼리 묶어서 관리르 하자는 입장**이다. 문제가 발생했을 때, 관심사가 같은 것들끼리 묶어서 관리를 하게되면 **문제의 범위를 각 객체로 좁힐 수 있고**, 동일한 관심사로 모인 객체들을 작은 프로그램으로 취급하여 조립하고, 서로 소통할 수 있도록 하자는 관점이다
